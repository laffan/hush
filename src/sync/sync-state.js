...
/**
 * 409-conflict resolver lives in `sync-conflict-handler.js` (extracted
 * to keep this file under the 700-line build cap). Re-exported here so
 * existing imports (`op-log.js#executeUpload`) keep resolving.
 */
export { handleUploadConflict } from "./sync-conflict-handler.js";
