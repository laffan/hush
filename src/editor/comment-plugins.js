...
// Plugin that handles ALL %% comment %% blocks — both single-line and
// multi-line. Applies inline opacity via `style` attributes so the
// user's comment-opacity slider takes effect regardless of
// HighlightStyle specificity or theme overrides.
