...
export const typeIcons = {
  ...
  // Gutter notebook: the notebook dot-grid flanked by a vertical rule on each
  // side, echoing the red gutter lines that bracket the docked canvas.
  gutter: `<svg viewBox="0 0 16 16" class="tree-type-icon notebook-icon gutter-icon"><line x1="1" y1="2.5" x2="1" y2="13.5" /><line x1="15" y1="2.5" x2="15" y2="13.5" /><circle cx="4" cy="4" r="1" /><circle cx="8" cy="4" r="1" /><circle cx="12" cy="4" r="1" /><circle cx="4" cy="8" r="1" /><circle cx="8" cy="8" r="1" /><circle cx="12" cy="8" r="1" /><circle cx="4" cy="12" r="1" /><circle cx="8" cy="12" r="1" /><circle cx="12" cy="12" r="1" /></svg>`,
