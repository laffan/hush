...
- **Focus Mode** (`⌘S`) dims everything but the current sentence — the sidebars fade to the same level, and highlights and the YOUAREHERE tag turn monochrome; **Typewriter Mode** pins the cursor to a fixed line.
